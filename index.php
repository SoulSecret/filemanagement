...
<body style="background-color:2">
    <div class="container-scroller">
        <div class="container-fluisd page-body-wrapper full-page-wrapper">
                        ...
                        <div class="auth-form-light text-left py-5 px-4 px-sm-5">
                            <center>
                                <div class="brand-logo">
                                    <span class="fw-bold " style="font-family: 'Protest Riot', sans-serif;color:navy">
                          ...
                          ?>
                                ...
                                <div class="my-2 d-flex justify-content-between align-items-center">
                                    ...
                                    <a href="#" class="auth-conn text-black" style="text-decoration:none">Forgot
                                        password?</a>
                                </div>
