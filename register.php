                        ...
                        <center>
                            <div class="brand-logo">
                                ...
                                <span class="fw-bold " style="font-family: Sofia,sans-serif;"> <span
                                        class="fs-1 ">Welcome</span> 
                            </div>
                            </center>
                            <h6 class="fw-light">Sign up</h6>
                            <form class="pt-3" autocomplete="off"
                                action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                                <div class="form-group">
                                <input type="text" name="name" class="form-control form-control-lg" id="exampleInputEmail1" placeholder="Full Name" required>
                                ...
                                <div class="form-group">
                                    <input type="text" name="pin" maxlength="4" class="form-control form-control-lg"
                                        id="exampleInputEmail1" placeholder="PIN" required>
                                ...
                                <div class="text-center mt-4 fw-light">
                                    Already have an account ? <a href="index.php" class="text-primary" style="text-decoration:none">Login</a>
                                </div>
                            </form>
                        </div>
                    </div>
