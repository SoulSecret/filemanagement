                                ...
                                <div class="card-body">
                                    ...
                                    <form class="forms-sample" action="php/upload_new_document.php" method="POST"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea id="desc" name="desc" class="form-control custom-textarea" rows="1" placeholder="Enter your description here" style="height:100px"></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Upload File </label>
                                            <input type="file" name="file" class="form-control" id="file" accept=".pdf,.docx,.doc,.pptx,.ppt,.xlsx,.xls,.odt" style="height:40px" required>
                                        </div>
