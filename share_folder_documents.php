                            ...
                            <div class="card">
                                <div class="card-body">
                                                        ...
                                                        <form action="php/add_new_share_folder_member.php"
                                                            ...
                                                            <div class="mb-3">
                                                                <label for="exampleInputEmail1"
                                                                    class="form-label">Choose User   </label>
                                                                <select name="member" id="" class="form-control">
                                                                    <option value="" selected hidden>Choose...</option>
                                                                    <?php
                                                                    // Fetch all users from the database
                                                                    $sql = "SELECT * FROM users  WHERE user_id != $currentUserID";
                                                                    $result = $conn->query($sql);

                                                                    // Check if there are any users
                                                                    if ($result->num_rows > 0) {
                                                                        // Loop through each user and generate option tags
                                                                        while ($row = $result->fetch_assoc()) {
                                                                            ?>
                                    ...
                                    <p class="card-description">
                                        <!-- Member added successfully notification  -->
                                        <?php
                                    ...
                                    ?>
                                    <!-- Member already exists notification  -->
                                    <?php
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    if (isset($_SESSION['memberremoved'])) {
                                        ?>
                                    <div id="notification" class="alert alert-success" role="alert">
                                        <b> <i class="bi bi-check-circle-fill"></i>Success ! </b> Member removed
                                        successfully.
                                    </div>
                                    <?php
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <!-- calculate how many documents user shared  -->
                                                        <?php
